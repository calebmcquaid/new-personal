...
const BioPage = () => (
  <div>
    ...
    <Feed>
        ...
        <Content>Hello! My name is Caleb McQuaid and I am a software developer at Booz Allen Hamilton. I work on a large team of other developers, QA's, and project leads to produce a very large and intricate piece of software for a government agency. This requires me to write Java and Javascript code to add features and fix defects on the legacy software. While that is my primary postition, I am also available for freelance and contract work! I have experience in building anything from Slack bots in Ruby to writing original OAuth strategies to work in my cross-platform fitness application. When I'm not programming, I am typically spending time with my wife exploring Charleston. We recently moved here and we love it! Please check out my website, Twitter, and reach out if you need anything!<br/><br/> -Caleb</Content>
    </Feed>
  </div>
)
